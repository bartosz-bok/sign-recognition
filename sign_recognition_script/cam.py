...
device = 'cuda'
# Class names.
sign_names_df = pd.read_csv('/data/input/signnames.csv')
class_names = sign_names_df.SignName.tolist()

# DataFrame for ground truth.
gt_df = pd.read_csv(
    '/data/input/GTSRB_Final_Test_GT/GT-final_test.csv',
    delimiter=';'
)
...
all_images = glob.glob('/data/input/GTSRB_Final_Test_Images/GTSRB/Final_Test/Images/*.ppm')  # change to '../input/...'
correct_count = 0
